...
var sheetToExport = "Profit by Subcategory";
...
function renderVizMoreOptions() {
    ...
    var mainVizOptions = {
        ...
        //vvvv No initial category options for now -NB
        ...
        //vvvv No initial "Top Customers" for now -NB
        //"Top Customers": 22,
...
function showExportCrosstabDialog() {
    ...
    mainViz.showExportCrossTabDialog(sheetToExport);
}


function exportData() {
    // View the data of a specific sheet in a dashboard
    mainViz.showExportDataDialog(dataToExport);
}
